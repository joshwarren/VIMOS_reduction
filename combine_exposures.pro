...
files = FILE_SEARCH(dataset + '/*_darc.fits',count=c)
if c eq 0 then files = FILE_SEARCH(dataset + '/*_cor.fits', count=c)
if c eq 0 then files = FILE_SEARCH(dataset + '/*_vmcmb.fits')
